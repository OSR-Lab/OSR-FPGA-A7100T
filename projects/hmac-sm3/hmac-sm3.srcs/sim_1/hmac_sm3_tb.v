...
// Testbench for hmac_sm3_recv
// Sends 32 bytes (16B key + 16B msg) via UART, receives 32 bytes HMAC digest,
// compares against pycryptodomex-computed reference.
//
// Test vector:
//   Key:  000102030405060708090a0b0c0d0e0f
//   Msg:  00112233445566778899aabbccddeeff
//   Inner digest: a2d05ca3e8dc5da5529752e548a93b4824f8f68f59c2b57847485e8dee042716
...
initial begin
    ...
    expected_hmac = 256'hb5d7f050eab1c2d6d53ed474cfaa6a80c9b0667877b90c5f1be095946c212739;

    // Wait for DUT reset to complete (rst_cnt reaches 8)
    #(CLK_PERIOD * 20);

    $display("=== HMAC-SM3 Testbench ===");
