...
//
// Ports:
//   clk       - system clock (8MHz, PLL output)
...
// `define CLK_PERIORD     20   // Clock period in ns, 50MHz (no PLL, direct clock)
`define CLK_PERIORD     125  // Clock period in ns, 8MHz (PLL output)
